...
enum ClickKeys: Int32, EventExtraKey {
    case objectId = 0
    case other = 1
...
class EventMetricTypeTests: XCTestCase {
    ...
    func testEventSavesToStorage() {
        ...
        let metric = EventMetricType<ClickKeys, ClickExtras>(CommonMetricData(
            category: "ui",
            name: "click",
            sendInPings: ["store1"],
            lifetime: .ping,
    ...
    func testEventNotRecordWhenUploadDisabled() {
        let metric = EventMetricType<TestNameKeys, NoExtras>(CommonMetricData(
            category: "ui",
            name: "click",
            sendInPings: ["store1", "store2"],
            lifetime: .ping,
    ...
    func testFlushQueuedEventsOnStartup() {
        ...
        let event = EventMetricType<SomeExtraKeys, NoExtras>(CommonMetricData(
            category: "telemetry",
            name: "test_event",
            sendInPings: ["events"],
            lifetime: .ping,
